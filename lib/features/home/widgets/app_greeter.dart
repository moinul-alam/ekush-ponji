...
extension _PeriodData on _TimePeriod {
  ...
  /// Returns [gradientStart, gradientEnd, textColor, iconColor]
  ...
  List<Color> colors(Brightness brightness) {
    ...
    switch (this) {
      case _TimePeriod.morning:
        return isDark
            ? [
                const Color(0xFFB56A00), // warm amber, darkened
                const Color(0xFF00513F), // primaryContainer dark
                const Color(0xFFFFE0B2),
                const Color(0xFFFFCC80),
              ]
            : [
                const Color(0xFFFFB74D), // warm amber
                const Color(0xFF7FF9D4), // primaryContainer light
      ...
      case _TimePeriod.afternoon:
        return isDark
            ? [
                const Color(0xFF00513F), // primaryContainer dark
                const Color(0xFF244C5A), // tertiaryContainer dark
                const Color(0xFF7FF9D4),
                const Color(0xFFA5CCDF),
              ]
            : [
                const Color(0xFF7FF9D4), // primaryContainer light
                const Color(0xFFC1E8FB), // tertiaryContainer light
      ...
      case _TimePeriod.evening:
        return isDark
            ? [
                const Color(0xFF7A2200), // deep orange darkened
                const Color(0xFF334B42), // secondaryContainer dark
                const Color(0xFFFFCCBC),
                const Color(0xFFFF8A65),
              ]
            : [
                const Color(0xFFFF7043), // deep orange
                const Color(0xFFCCE8DB), // secondaryContainer light
      ...
      case _TimePeriod.night:
        return isDark
            ? [
                ...
                const Color(0xFF0D2B1F), // dark teal
                const Color(0xFFBBDEFB),
                const Color(0xFF90CAF9),
              ]
            : [
                const Color(0xFF303F9F), // indigo
                const Color(0xFF1B4332), // dark teal
